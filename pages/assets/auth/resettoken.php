...
if (isset($_POST['resetsubmit'])) {
    ...
    */
    ...
    if (empty($selector) || empty($validator)) {
        ...
        $_SESSION['STATUS']['resentsend'] = 'Invalid token, please retry!';
        header("location:".$_SERVER['HTTP_REFERER']);
        exit();
    }
    if (empty($password) || empty($passwordRepeat)) {
        ...
        $_SESSION['ERRORS']['passworderror'] = 'The passwords do not match!';
        header("Location: " . $_SERVER['HTTP_REFERER']);
        exit();
    }
    ...
    if (!mysqli_stmt_prepare($stmt, $sql)) {
        ...
        if (!($row = mysqli_fetch_assoc($results))) {
            ...
            $_SESSION['STATUS']['resentsend'] = 'Token expired or inexistant, please retry!';
            header("location:".$_SERVER['HTTP_REFERER']);
            exit();
        }
        else {
                    ...
                    if (!$row = mysqli_fetch_assoc($results)) {
                        ...
                        if (!mysqli_stmt_prepare($stmt, $sql))
                        {
                            ...
                            if (!mysqli_stmt_prepare($stmt, $sql)){
                                ...
                                $_SESSION['STATUS']['loginstat'] = 'Password updated, please sing in!';
