<?php include_once 'layout.php';
      ...
      $sql = "SELECT ID, Username, Email, CreationDate, LastLogin, Image, Is_Active, Is_Verified FROM users WHERE role='user';";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group dropleft">
                                                <i class="icon-options-vertical" type="button" data-toggle="dropdown"
